...
export default async function ProfilePage({ params }: ProfilePageProps) {
  ...
  return (
    <HomeLayout>
      <div className="bg-gray-50 dark:bg-black sticky top-0 z-50 max-lg:relative max-lg:z-0">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="sticky top-0 z-10 bg-white/80 dark:bg-black backdrop-blur-sm p-2 border-b max-lg:relative">
            ...
            <div className="mt-16 px-4">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-2 mt-4 text-gray-500 dark:text-gray-400">
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    Joined {format(userProfile.createdAt, "MMM yyyy")}
                  </span>
                </div>
              </div>
